<?php include('header.php');?>
        <meta property="og:image" content="<?php echo $baseball;?>" />
      ...
      <h1 style="text-align:center;color: #dcdcdc;margin-top:0px;"><?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?></h1>
				...
				<div id="video">
					<div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext">
						<video id="videoPlayer" class="embed-responsive-item" preload="none" poster="<?php echo $baseball;?>">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="modal-footer">
					<div class="text-center">
						<button class="btn btn-warning btn-lg btn-responsive" onclick="window.location.href='/sign-in.php?match=<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?>&live=<?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?>'">
							
								<span class="icon icon-arrow-right-circle"></span>
							</span> Sign In
						</button>
						<button class="btn btn-success btn-lg btn-responsive" onclick="window.location.href='/continue.php?match=<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?>&live=<?php echo '' . htmlspecialchars($_GET["live"]) . ''; ?>'">
